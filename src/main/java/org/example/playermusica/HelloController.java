...
public class HelloController {
    ...
    private void carregarMusicas() {
        ...
        musicas.add("musicas/m1.m4e");
        musicas.add("musicas/m2.m4e");
        indiceMusicaAtual = 0;
    ...
    public void mudo() {
        if(mediaPlayer.isMute()) {
            ...
            mediaPlayer.setVolume(sletorVolume.getValue());
            volume = sletorVolume.getValue();
        }else {
    ...
    private void ajustarVolume() {
        ...
        sletorVolume.valueProperty().addListener((obs, valorAntigo, valorNovo) -> {
